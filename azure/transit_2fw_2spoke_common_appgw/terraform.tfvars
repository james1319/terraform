...
fw_prefix               = "jpetti-vmseries"                                         # Adds prefix name to all resources created in the firewall resource group
fw_count                = 2
fw_panos                = "9.0.1"
...
transit_prefix          = "jpetti-transit"                                         # Adds prefix name to all resources created in the transit vnet's resource group
...
spoke1_prefix           = "jpetti-spoke1"                                          # Adds prefix name to all resources created in spoke1's resource group
spoke1_vm_count         = 2
spoke1_vnet_cidr        = "10.1.0.0/16"
spoke1_subnet_cidrs     = ["10.1.0.0/24"]
spoke1_internal_lb_ip   = "10.1.0.100"

spoke2_prefix           = "jpetti-spoke2"                                          # Adds prefix name to all resources created in spoke2's resource group
spoke2_vm_count         = 1
